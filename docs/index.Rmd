...
Nas ciências florestais, as aplicações mais recentes usando técnicas de ``Aprendizado Supervisionado'' incluem: 1) modelagem de variáveis biométricas, tais como altura \cite{da2013aplicaccao}, volume de árvores \cite{soares2011recursive, binoti2014configuraccao}, afilamento do fuste \cite{schikowski2015estudo, schikowski2018modeling}, biomassa \cite{fehrmann2008comparison, sanquetta2015comparison, vahedi2016artificial}, carbono \cite{sanquetta:2013use}, volume e espessura de casca \cite{diamantopoulou2010modelling, nieto2012support}, e densidade básica da madeira \cite{leite2016redes}; 2) modelagem de crescimento individual e produção florestal \cite{ashraf2015novel}; 3) modelagem da mortalidade, sobrevivência e recrutamento \cite{Reis2018, Rocha2018, Reis2019}; 4) modelagem de atributos florestais a partir de dados de sensoriamento remoto \cite{aguirre2009mapping, mcroberts2012estimating}; 5) mapeamento e classificação de florestas \cite{kuplich2006classifying}; 6) reconhecimento de espécies florestais \cite{martins2013database, paula2014forest, martins2015forest, maruyama2018automatic}; 7) reconhecimento de doenças em plantas \cite{singh2017detection}; 8) previsão de incêndios florestais \cite{sakr2010artificial}.
