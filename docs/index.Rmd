...
---
class: middle, center
# Regressão linear clássica x aprendizado de máquina

```{r, echo=FALSE, out.width='48%', fig.align='center', fig.cap=''}
knitr::include_graphics('fig/SWOT.png')
```
...
[01-Regression-Tree](https://deivisonsouza.github.io/IA-Potencial-IF/R-scripts/01-Regression-Tree.R)
