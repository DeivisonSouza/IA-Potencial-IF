...
.pull-left[
[1 - Aprendizado de Máquina (AM)](#AM)

[2 - Tipos de Aprendizagem](#tipos)

[3 - Aprendizado Supervisionado](#AS)

[4 - Aplicações nas ciências florestais](#aplicacoes)

[5 - Aprendizado de Máquina no Inventário Florestal](#AMIF)

[6 - Aprendizado de Máquina com linguagem R](#AMLR)

[7 - Pacote CARET: um framework para AM](#caret)

[8 - Fluxograma - modelo de AM usando CARET](#fluxo)

[9 - Aprendizado de Máquina no R: exemplo prático](#exemploR)

[10 - Como disponibilizar os MAM? um exemplo prático.](#shiny)
...
.bg-washed-near-white.b--dark-green.ba.bw2.br3.shadow-5.ph4.mt5[
.center[<bdi style="font-weight:bold"> *Classificação*</bdi>]

Uma tarefa de classificação é quando a .thick[variável resposta é uma categoria].
...
.bg-washed-near-white.b--dark-green.ba.bw2.br3.shadow-5.ph4.mt5[
.center[<bdi style="font-weight:bold"> *Regressão*</bdi>]

Um tarefa de regressão é quando a .thick[variável resposta é um valor real (numérica)].
...
102 pacotes de AM publicados no CRAN Task View.
]
...
.thick[.black[Acesse aplicações para predição de biomassa e volume:]]
